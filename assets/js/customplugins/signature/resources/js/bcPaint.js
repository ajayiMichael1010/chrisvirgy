	...
	**/
	var isDragged		= false,
		...
		templates 		= {
							...
							canvasContainer : $('<div class="col-sm-9 col-md-9" id="bcPaint-canvas-container">Please sign here</div>'),
							...
							buttonSave		: $('<button type="submit" class="btn btn-primary btn-sm ml-1" id="bcPaint-export"><i class="fas fa-download"></i> Upload Signature</button>')
						},
		paintCanvas,
		paintContext;
